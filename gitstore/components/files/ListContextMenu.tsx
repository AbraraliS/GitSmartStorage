 ...
 * ListContextMenu
 *
 * SSR-safe portal context menu via ClientPortal.
 * Anchors to trigger button bounding rect with viewport collision detection.
 */
    ...
    <ClientPortal>
      ...
      >
        {file && (
          <>
            <button type="button" role="menuitem" className={itemClass} onClick={onPreview}>
              <EyeIcon className="h-4 w-4 shrink-0" /> Open preview
            </button>
            <button type="button" role="menuitem" className={itemClass} onClick={onDownload}>
              <DownloadIcon className="h-4 w-4 shrink-0" /> Download
            </button>
        ...
        {folder && (
          <>
            <button type="button" role="menuitem" className={itemClass} onClick={onOpenFolder}>
              <FolderIcon className="h-4 w-4 shrink-0" /> Open folder
            </button>
            <div className="my-1 border-t border-gray-200 dark:border-gray-700" />
          </>
        )}
        ...
        <button type="button" role="menuitem" className={itemClass} onClick={onRename}>
          <PencilIcon className="h-4 w-4 shrink-0" /> Rename
        </button>
        <button type="button" role="menuitem" className={itemClass} onClick={onMove}>
          <FolderInputIcon className="h-4 w-4 shrink-0" /> Move to…
        </button>
        ...
        {file && (
          <>
            ...
            <button
              ...
              onClick={onTrash}
            >
              <Trash2Icon className="h-4 w-4 shrink-0" /> Move to trash
            </button>
          </>
        )}
      </div>
